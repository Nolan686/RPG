...
void AnimationClips::playerRightRunningClips()
{
...
void AnimationClips::playerStandStillLeftClips()
{


}
void AnimationClips::playerStandStillRightClips()
{
	playerStandStillRight.playerStandStillRightClips[0].x = 26;
	playerStandStillRight.playerStandStillRightClips[0].y = 0;
	playerStandStillRight.playerStandStillRightClips[0].w = 81;
	playerStandStillRight.playerStandStillRightClips[0].h = 150;

	playerStandStillRight.playerStandStillRightClips[1].x = 122;
	playerStandStillRight.playerStandStillRightClips[1].y = 0;
	playerStandStillRight.playerStandStillRightClips[1].w = 81;
	playerStandStillRight.playerStandStillRightClips[1].h = 150;

	playerStandStillRight.playerStandStillRightClips[2].x = 215;
	playerStandStillRight.playerStandStillRightClips[2].y = 0;
	playerStandStillRight.playerStandStillRightClips[2].w = 81;
	playerStandStillRight.playerStandStillRightClips[2].h = 150;

	playerStandStillRight.playerStandStillRightClips[3].x = 310;
	playerStandStillRight.playerStandStillRightClips[3].y = 0;
	playerStandStillRight.playerStandStillRightClips[3].w = 81;
	playerStandStillRight.playerStandStillRightClips[3].h = 150;

	playerStandStillRight.playerStandStillRightClips[4].x = 407;
	playerStandStillRight.playerStandStillRightClips[4].y = 0;
	playerStandStillRight.playerStandStillRightClips[4].w = 81;
	playerStandStillRight.playerStandStillRightClips[4].h = 150;

	playerStandStillRight.playerStandStillRightClips[5].x = 498;
	playerStandStillRight.playerStandStillRightClips[5].y = 0;
	playerStandStillRight.playerStandStillRightClips[5].w = 81;
	playerStandStillRight.playerStandStillRightClips[5].h = 150;

	playerStandStillRight.playerStandStillRightClips[6].x = 594;
	playerStandStillRight.playerStandStillRightClips[6].y = 0;
	playerStandStillRight.playerStandStillRightClips[6].w = 81;
	playerStandStillRight.playerStandStillRightClips[6].h = 150;

	playerStandStillRight.playerStandStillRightClips[7].x = 690;
	playerStandStillRight.playerStandStillRightClips[7].y = 0;
	playerStandStillRight.playerStandStillRightClips[7].w = 81;
	playerStandStillRight.playerStandStillRightClips[7].h = 150;

	playerStandStillRight.playerStandStillRightClips[8].x = 786;
	playerStandStillRight.playerStandStillRightClips[8].y = 0;
	playerStandStillRight.playerStandStillRightClips[8].w = 81;
	playerStandStillRight.playerStandStillRightClips[8].h = 150;

	playerStandStillRight.playerStandStillRightClips[9].x = 885;
	playerStandStillRight.playerStandStillRightClips[9].y = 0;
	playerStandStillRight.playerStandStillRightClips[9].w = 81;
	playerStandStillRight.playerStandStillRightClips[9].h = 150;

	playerStandStillRight.playerStandStillRightClips[10].x = 982;
	playerStandStillRight.playerStandStillRightClips[10].y = 0;
	playerStandStillRight.playerStandStillRightClips[10].w = 81;
	playerStandStillRight.playerStandStillRightClips[10].h = 150;

	playerStandStillRight.playerStandStillRightClips[11].x = 1078;
	playerStandStillRight.playerStandStillRightClips[11].y = 0;
	playerStandStillRight.playerStandStillRightClips[11].w = 81;
	playerStandStillRight.playerStandStillRightClips[11].h = 150;

	playerStandStillRight.playerStandStillRightClips[12].x = 1170;
	playerStandStillRight.playerStandStillRightClips[12].y = 0;
	playerStandStillRight.playerStandStillRightClips[12].w = 81;
	playerStandStillRight.playerStandStillRightClips[12].h = 150;

	playerStandStillRight.playerStandStillRightClips[13].x = 1262;
	playerStandStillRight.playerStandStillRightClips[13].y = 0;
	playerStandStillRight.playerStandStillRightClips[13].w = 81;
	playerStandStillRight.playerStandStillRightClips[13].h = 150;

	playerStandStillRight.playerStandStillRightClips[14].x = 1355;
	playerStandStillRight.playerStandStillRightClips[14].y = 0;
	playerStandStillRight.playerStandStillRightClips[14].w = 81;
	playerStandStillRight.playerStandStillRightClips[14].h = 150;

	playerStandStillRight.playerStandStillRightClips[15].x = 1449;
	playerStandStillRight.playerStandStillRightClips[15].y = 0;
	playerStandStillRight.playerStandStillRightClips[15].w = 81;
	playerStandStillRight.playerStandStillRightClips[15].h = 150;

	playerStandStillRight.playerStandStillRightClips[16].x = 1543;
	playerStandStillRight.playerStandStillRightClips[16].y = 0;
	playerStandStillRight.playerStandStillRightClips[16].w = 81;
	playerStandStillRight.playerStandStillRightClips[16].h = 150;

	playerStandStillRight.playerStandStillRightClips[17].x = 1638;
	playerStandStillRight.playerStandStillRightClips[17].y = 0;
	playerStandStillRight.playerStandStillRightClips[17].w = 81;
	playerStandStillRight.playerStandStillRightClips[17].h = 150;

	playerStandStillRight.playerStandStillRightClips[18].x = 1734;
	playerStandStillRight.playerStandStillRightClips[18].y = 0;
	playerStandStillRight.playerStandStillRightClips[18].w = 81;
	playerStandStillRight.playerStandStillRightClips[18].h = 150;

	playerStandStillRight.playerStandStillRightClips[19].x = 1834;
	playerStandStillRight.playerStandStillRightClips[19].y = 0;
	playerStandStillRight.playerStandStillRightClips[19].w = 81;
	playerStandStillRight.playerStandStillRightClips[19].h = 150;

	playerStandStillRight.playerStandStillRightClips[20].x = 1928;
	playerStandStillRight.playerStandStillRightClips[20].y = 0;
	playerStandStillRight.playerStandStillRightClips[20].w = 81;
	playerStandStillRight.playerStandStillRightClips[20].h = 150;

	playerStandStillRight.playerStandStillRightClips[21].x = 2028;
	playerStandStillRight.playerStandStillRightClips[21].y = 0;
	playerStandStillRight.playerStandStillRightClips[21].w = 81;
	playerStandStillRight.playerStandStillRightClips[21].h = 150;
